...
public class ExamController {
    ...
    @PostMapping("/save")
    @PreAuthorize("hasAnyRole('INSTRUCTOR')")
    public ResponseEntity<ResponseDto<ExamResponseDto>> createExam(@RequestBody ExamDto examDto) {
        ResponseDto<ExamResponseDto> responseDto = examService.createExam(examDto);
